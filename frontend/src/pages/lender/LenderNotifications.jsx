...
export default function LenderNotifications() {
    ...
    return (
        <div className="space-y-6 animate-fade-in pt-6 pb-6">
            {/* Header */}
            <div>
                <h1 className="text-2xl font-black text-slate-900 mb-0.5">Notifications</h1>
                <p className="text-slate-500 text-[11px] font-bold uppercase tracking-wider">Manage your recovery alerts and activity</p>
            </div>
...
function StatCard({ label, value, sub, icon, iconBg }) {
    return (
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex justify-between items-start hover:shadow-md transition-all">
            <div>
                <p className="text-slate-500 text-[10px] font-black mb-1.5 uppercase tracking-widest">{label}</p>
                <h2 className="text-2xl font-black text-slate-900 mb-0.5">{value}</h2>
                ...
                <div className="flex-1">
                    <div className="flex justify-between items-start mb-0.5">
                        <div className="flex items-center gap-2">
                            ...
                            {item.unread && (
                                <span className="bg-indigo-600 text-white text-[9px] font-black px-1.5 py-0.5 rounded-full uppercase">New</span>
                            )}
                        </div>
                    ...
                    <div className="flex gap-2">
                        <button
                            onClick={onView}
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-200 text-[10px] font-bold text-gray-600 hover:bg-gray-50 transition-colors"
                        >
                        ...
                        {item.unread && (
                            <button
                                onClick={onRead}
                                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-bold text-gray-600 hover:bg-gray-50 transition-colors"
                            >
                        ...
                        <button
                            onClick={onDelete}
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-bold text-red-500 hover:bg-red-50 transition-colors ml-auto md:ml-0"
                        >
