            ...
            <div className="p-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="button"
                    onClick={() => setShowEnvelopeFilters(!showEnvelopeFilters)}
                    className={`px-4 py-2.5 border rounded-lg text-sm font-medium flex items-center gap-2 transition-colors ${
                      showEnvelopeFilters ? 'bg-indigo-50 border-indigo-300 text-indigo-700' : 'border-gray-300 text-gray-700 hover:bg-gray-50'
                    }`}
                  >
              ...
              {showEnvelopeFilters && (
                <div className="flex flex-wrap gap-4 mb-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                  <div className="flex flex-col gap-1.5 min-w-[160px]">
                    ...
                    <select
                      value={envelopeTypeFilter}
                      onChange={(e) => setEnvelopeTypeFilter(e.target.value)}
                  ...
                  <div className="flex flex-col gap-1.5 min-w-[160px]">
                    ...
                    <select
                      ...
                      onChange={(e) => setEnvelopeStatusFilter(e.target.value)}
                      className="border border-gray-300 rounded-lg px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    >
                  ...
                  <div className="flex items-end">
                    <button
                      type="button"
                      onClick={() => {
                        setEnvelopeTypeFilter('All Types')
                        setEnvelopeStatusFilter('All Statuses')
                      }}
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  ...
                  className={`px-4 py-2.5 border rounded-lg text-sm font-medium flex items-center gap-2 transition-colors ${
                    showDocumentFilters ? 'bg-indigo-50 border-indigo-300 text-indigo-700' : 'border-gray-300 text-gray-700 bg-white hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" /></svg>
                  Filters
              ...
              {showDocumentFilters && (
                <div className="flex flex-wrap gap-4 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                  <div className="flex flex-col gap-1.5 min-w-[160px]">
                  ...
                  <div className="flex items-end">
                    <button
                      type="button"
                      onClick={() => {
                        setDocumentTypeFilter('All Types')
                        setDocumentStatusFilter('All Statuses')
                      }}
                      className="text-xs font-medium text-indigo-600 hover:text-indigo-800 mb-2"
                    >
                      Reset Filters
                ...
                >
                  ...
                  {uploadDocumentFile ? (
                    ...
                    <div className="text-center">
                      <svg className="w-8 h-8 text-gray-400 mx-auto mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4-4m0 0l-4 4m4-4v12" /></svg>
