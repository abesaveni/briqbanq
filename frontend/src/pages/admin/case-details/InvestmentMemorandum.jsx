    ...
    return (
        <div className="space-y-4 pb-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-base font-semibold text-gray-900">Investment Memorandum</h2>
                    <p className="text-xs text-gray-500 mt-0.5">Official investment dossier · Case {id}</p>
                </div>
