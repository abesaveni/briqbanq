...
const navItems = [
    { label: 'Dashboard', path: '/lawyer/dashboard', icon: 'dashboard', color: 'text-[#3474E1]' },
    { label: 'Submit New Case', path: '/lawyer/submit-case', icon: 'add', color: 'text-green-600' },
...
const NavIcon = ({ icon, className }) => {
  ...
  if (icon === 'console') {
    return <svg className={c} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
  }
  if (icon === 'settings') {
...
export default function LawyerTopNavBar() {
  ...
  const userName = user?.name || 'Lawyer User'
